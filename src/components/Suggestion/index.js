...
export function Suggestion() {
    ...
    useEffect(() => {
        fetch(`https://api.github.com/users/Henriquegcosta/followers`)
        .then((response) => {
    ...
    return (
        <div className="container-suggestion">
            <div className="header-suggestion" >
                <img src={`https://github.com/Henriquegcosta.png`} />

                <div className="user-infos-suggestion" >

                    <div className="infos" >
                        <span>Henrique Gonçalves</span>
                        <p>Henriquegcosta</p>
                    </div>
